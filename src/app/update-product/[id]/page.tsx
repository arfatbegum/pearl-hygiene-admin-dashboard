                    ...
                    <div className="p-6.5">
                        ...
                        <div className="">
                            <div className="">
                                ...
                                <button
                                    type="button"
                                    onClick={handleSpecificationAdd} className="mb-4.5 inline-flex h-12 items-center justify-center rounded border border-stroke bg-primary py-3 px-6 text-base font-medium text-white transition hover:bg-opacity-90 focus:outline-none"
                        ...
                        <div className="mb-4.5">
                            ...
                            <Editor
                                ...
                                onEditorChange={(content) => setProduct({ ...product, productDescription: content })}
                                init={{
                                    height: 300,
                                    menubar: false,
                                    plugins: [
                        ...
                        <div className="flex gap-5">
                            {imageUrls.map((url, index) => (
                                <div key={index} className="">
                                    <img className="mb-5 h-24" src={url} alt={`Product Image ${index}`} width="100" height="100" />
                                    <div className="flex">
