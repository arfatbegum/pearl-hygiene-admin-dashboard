                ...
                >
                    <div className="col-span-3 hidden items-center sm:flex">
                        <p className="text-sm text-black dark:text-white">
                            {typeof category.data === 'string' ? category.data : category.data.name}
                        </p>
                    </div>
                    <div className="col-span-3 flex items-center">
                        <p className="border-b border-[#eee]  py-5 dark:border-strokedark">
                            <div className="flex items-center space-x-3.5">
                                <button onClick={() => deleteCategory(category.id)} className="hover:text-primary">
                                    <svg
                                ...
                                <Link href={`/update-category/${category?.id}`} className="hover:text-primary">
