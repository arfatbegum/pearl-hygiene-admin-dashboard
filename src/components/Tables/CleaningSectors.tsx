  ...
  const deleteCleaningSector = async (sectorId: string) => {
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        setSectors((prevSectors) => prevSectors.filter((sector) => sector.id !== sectorId));
          ...
          <div className="col-span-1 flex items-center">
            <p className="border-b border-[#eee] py-5 dark:border-strokedark">
              <div className="flex items-center space-x-3.5">
                ...
                <button onClick={() => deleteCleaningSector(sector.id)} className="hover:text-primary">
                  <svg
                    className="fill-current "
                    width="18"
                    height="18"
                ...
                {/* <Link href={`/update-sector/${sector?.id}`} className="hover:text-primary">
